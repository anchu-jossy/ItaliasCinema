...
//    public void performNetworkCallForImage(final ResponseCallback callback, final boolean showProgress, String auth, String filename, File file, final String contentType, String type, final AttachPhoto attachPhoto) {
...
//    }
    ...
    public void performNetworkCallForArray(final ArrayResponseCallback callback, final boolean showProgress, String auth) {
        final ProgressDialog dialog;
        if (showProgress) {
            dialog = new ProgressDialog(context);
            dialog.setMessage("Please wait...");
    ...
    public void performNetworkCallToPostDataToServer(final ResponseCallback callback, final boolean showProgress, String auth, JsonObject jsonObject) {
        final ProgressDialog dialog;
        if (showProgress) {
            dialog = new ProgressDialog(context);
            dialog.setMessage("Please wait...");
...
//        }
    ...
    public void performNetworkCall(final ResponseCallback callback, final boolean showProgress, String auth) {
        final ProgressDialog dialog;
        if (showProgress) {
            dialog = new ProgressDialog(context);
            dialog.setMessage("Please wait...");
...
//            dialog.show();
    ...
    public void performNetworkCallToolList(final ResponseCallback callback, final boolean showProgress, String auth) {
        final ProgressDialog dialog;
        if (showProgress) {
            dialog = new ProgressDialog(context);
            dialog.setMessage("Please wait...");
    ...
    public void performNetworkCallToPostData(final ResponseCallback callback, final boolean showProgress, String auth, JsonObject jsonObject) {
        final ProgressDialog dialog;
        if (showProgress) {
            dialog = new ProgressDialog(context);
            dialog.setMessage("Please wait...");
    ...
    public void performNetworkCallToPostDataforMoveItem(final ResponseCallback callback, final boolean showProgress, String auth, JsonObject jsonObject) {
        final ProgressDialog dialog;
        if (showProgress) {
            dialog = new ProgressDialog(context);
            dialog.setMessage("Please wait...");
    ...
    public void performNetworkCallToPostDataforOngoingFormula(final ResponseCallback callback, final boolean showProgress, String auth, JsonObject jsonObject) {
        final ProgressDialog dialog;
        if (showProgress) {
            dialog = new ProgressDialog(context);
            dialog.setMessage("Please wait...");
    ...
    public void performNetworkCallToPostDataforGetGuid(final ResponseCallback callback, final boolean showProgress, String auth) {
        final ProgressDialog dialog;
        if (showProgress) {
            dialog = new ProgressDialog(context);
            dialog.setMessage("Please wait...");
